...
App.DATABASE_POD_ASYNC_URL = 'js/podasync.min.js';
    ...
    if (!mxClient.IS_CHROMEAPP) {
        ...
        if (window.mxscript != null) {
            ...
            if (urlParams['embed'] != '1') {
                ...
                if (typeof window.DatabaseClient === 'function') {
                    mxscript(App.DATABASE_POD_ASYNC_URL);
                }
            }
...
App.main = function(callback, createUi) {
    ...
    function doLoad(bundle) {
        ...
        mxUtils.getAll((urlParams['dev'] != '1')
            ...
            document.getElementById('geStatus')
...
App.prototype.updateActionStates = function() {
    ...
    var file = this.getCurrentFile();
    this.actions.get('revisionHistory')
        .setEnabled(file != null && ((file.constructor == DriveFile &&
...
App.prototype.getThumbnail = function(width, success) {
    ...
    try {
        ...
        if (mxClient.IS_CHROMEAPP || (!graph.mathEnabled && this.useCanvasForExport)) {
            ...
            imgExport.drawState(graph.getView()
                .getState(graph.model.root), asynCanvas);

            asynCanvas.finish(mxUtils.bind(this, function() {
                imgExport.drawState(graph.getView()
                    .getState(graph.model.root), htmlCanvas);
...
mxCodecRegistry.getCodec(mxCell)
    .exclude
    .push('rtCell');
...
App.prototype.pickFile = function(mode) {
    ...
    if (mode == App.MODE_GOOGLE) {
        ...
        // input.click does not work in IE on Windows 7
            ...
            window.openFile.setConsumer(mxUtils.bind(this, function(xml, filename, fileId) {
                // Replaces PNG with XML extension
                ...
                this.fileLoaded((mode == App.MODE_DATABASE) ? new StorageFile(this, xml, filename, fileId) : new LocalFile(this, xml, filename));
            }));
...
App.prototype.pickLibrary = function(mode) {
    ...
    if (mode == App.MODE_GOOGLE || mode == App.MODE_DROPBOX || mode == App.MODE_ONEDRIVE || mode == App.MODE_GITHUB || mode == App.MODE_TRELLO) {
        var peer = (mode == App.MODE_GOOGLE) ? this.drive : ((mode == App.MODE_ONEDRIVE) ? this.oneDrive : ((mode == App.MODE_GITHUB) ? this.gitHub : ((mode ==
        App.MODE_TRELLO) ? this.trello : this.dropbox)));
        ...
        window.openFile.setConsumer(mxUtils.bind(this, function(xml, filename) {
            try {
                this.loadLibrary((mode == App.MODE_BROWSER) ? new StorageLibrary(this, xml, filename) : new LocalLibrary(this, xml, filename));
            }
            catch (e) {
                this.handleError(e, mxResources.get('errorLoadingFile'));
            }
...
App.prototype.saveOnDatabase = function() {
    var file = this.getCurrentFile();
    var name = file.getTitle();
    var data = this.getFileData(/(\.xml)$/i.test(name) || name.indexOf('.') < 0, /(\.svg)$/i.test(name), /(\.html)$/i.test(name));
    ...
    if (file != null && file.getFileId() > 0) {
        this.spinner.spin(document.body, mxResources.get('updatingOnDatabase'));
        this.editor.setStatus(mxUtils.htmlEntities(mxResources.get('savingOnDatabase')));

        this.database.insertFile(name, data, mxUtils.bind(this, function() {
            complete();
        }), error, file.getFileId());
    }
};
...
App.prototype.saveFile = function(forceDialog, success) {
    ...
    if (file != null) {
        ...
        if (!forceDialog && file.getTitle() != null && this.mode != null) {
            ...
            var rowLimit = (serviceCount <= 2) ? 2 : (serviceCount > 6 ? 4 : 3);
            ...
            var dlg = new CreateDialog(this, filename, mxUtils.bind(this, function(name, mode) {
                        ...
                        if (prev == null && mode == App.MODE_DEVICE) {
                            ...
                            this.pickFolder(mode, mxUtils.bind(this, function(folderId) {
                                this.createFile(name, this.getFileData(/(\.xml)$/i.test(name) ||
                                    ...
                                    this.mode == null, folderId, null, (mode == 'database') ? file.getFileId() : 0);
                            }));
                        }
                        else if (mode != null) {
                            this.save(name, done);
                ...
                (this.isOffline()) ? null : 'https://desk.draw.io/support/solutions/articles/16000042485', true, rowLimit);
 ...
 * @param {number} dy Y-coordinate of the translation.
 */
App.prototype.createFile = function(title, data, libs, mode, done, replace, folderId, tempFile, databaseFileId) {
    ...
    if (title != null && this.spinner.spin(document.body, mxResources.get('inserting'))) {
        ...
        try {
            if (mode == App.MODE_GOOGLE && this.drive != null) {
                ...
                var fn = mxUtils.bind(this, function() {
                    var file = new StorageFile(this, data, title, databaseFileId);
                ...
                this.database.insertFile(title, data, mxUtils.bind(this, function(file) {
                    complete();
                    // todo check this
                    // this.fileCreated(file, libs, replace, done);
                }), error, databaseFileId);
            }
            else {
                complete();
...
App.prototype.loadFile = function(id, sameWindow, file, success) {
    ...
    var fn2 = mxUtils.bind(this, function() {
        if (id == null || id.length == 0) {
            ...
            // todo : implement CRUD on database
...
App.prototype.pickFolder = function(mode, fn, enabled) {
    ...
    else if (enabled && mode == App.MODE_DATABASE && this.database != null) {
        this.database.pickFolder(mxUtils.bind(this, function(cardId) {
            resume();
            fn(cardId);
        }));
    }
...
App.prototype.exportFile = function(data, filename, mimeType, base64Encoded, mode, folderId) {
    if (mode == App.MODE_DROPBOX) {
        if (this.dropbox != null && this.spinner.spin(document.body, mxResources.get('saving'))) {
            ...
            this.dropbox.insertFile(filename, (base64Encoded) ? this.base64ToBlob(data, mimeType) : data, mxUtils.bind(this, function() {
                this.spinner.stop();
            }), mxUtils.bind(this, function(resp) {
                this.spinner.stop();
                this.handleError(resp);
        ...
        if (this.oneDrive != null && this.spinner.spin(document.body, mxResources.get('saving'))) {
            ...
            this.oneDrive.insertFile(filename, (base64Encoded) ? this.base64ToBlob(data, mimeType) : data, mxUtils.bind(this, function() {
                this.spinner.stop();
            }), mxUtils.bind(this, function(resp) {
                this.spinner.stop();
                this.handleError(resp);
        ...
        if (this.trello != null && this.spinner.spin(document.body, mxResources.get('saving'))) {
            this.trello.insertFile(filename, (base64Encoded) ? this.base64ToBlob(data, mimeType) : data, mxUtils.bind(this, function() {
                this.spinner.stop();
            }), mxUtils.bind(this, function(resp) {
                this.spinner.stop();
                this.handleError(resp);
...
App.prototype.updateHeader = function() {
    if (this.menubar != null) {
        ...
        this.appIcon.style.width = '60px';
        this.appIcon.style.backgroundColor = '#FFCC00';
        this.appIcon.style.height = this.menubarHeight + 'px';
        this.appIcon.style.backgroundSize = '80%';
        ...
        var logo = (!mxClient.IS_SVG)
            ...
            : 'url(data:image/svg+xml;base64,)';
        ...
        this.appIcon.style.backgroundSize = 'cover cover';
        ...
        this.fnameWrapper.style.left = '70px';
        ...
        if (urlParams['embed'] != '1') {
            ...
            this.menubar.container.style.paddingLeft = '72px';
            this.menubar.container.style.boxSizing = 'border-box';
            this.menubar.container.style.top = '29px';

            this.toolbar.container.style.paddingLeft = '10px';
        }
