(function()
{
	Sidebar.prototype.addBasicPalette = function()
	{
		...
		[
            ...
            this.createVertexTemplateEntry(s2 + '4_point_star;dx=0.8;', w, h, '', '4 Point Star', null, null, this.getTagsForStencil(gn, '4_point_star', dt).join(' ')),
            this.createVertexTemplateEntry(s2 + '3_point_star;dx=0.8;', w, h, '', '3 Point Star', null, null, this.getTagsForStencil(gn, '3_point_star', dt).join(' ')),
            this.createVertexTemplateEntry(s2 + '6_point_star', w, h * 0.9, '', '6 Point Stars', null, null, this.getTagsForStencil(gn, '6_point_star', dt).join(' ')),
			...
			this.createVertexTemplateEntry(s2 + 'donut;dx=25;', w, h, '', 'Donut Masoudi', null, null, this.getTagsForStencil(gn, 'donut', dt).join(' ')),
